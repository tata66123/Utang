...
class CreditEntry {
  ...
  final String? unit; // Unit of measurement (e.g., "pcs", "kg", "liters", "boxes")
  ...
  // Safely add payments with deduplication to prevent negative balances
  void addPaymentsSafely(List<Payment> newPayments) {
    final existingPaymentIds = payments.map((p) => p.id).toSet();
