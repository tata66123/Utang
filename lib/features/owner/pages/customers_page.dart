      ...
      itemBuilder: (context, index) {
        ...
        return ExpansionTile(
          ...
          subtitle: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Qty: ${credit.quantity} ${credit.unit ?? 'pcs'} × ₱${credit.effectiveUnitPrice.toStringAsFixed(2)} = ₱${credit.amount.toStringAsFixed(2)}', style: const TextStyle(fontSize: 12)),
